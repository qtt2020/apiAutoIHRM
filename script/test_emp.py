...
class TestEmployee(unittest.TestCase):
    ...
    def test03_show_emp(self):
        ...
        # 断言结果：响应状态码，success，code，message
        assert_emp(self, response_show_emp, 200, True, 10000, "操作成功！")

    # 调用员工接口 修改员工
    def test04_upData_emp(self):
        response_upData_emp = self.emp.get_upData_emp(self.session, app.HEADERS, "fjdk", app.EMP_ID)
        logging.info("员工模块修改员工信息为：{}".format(response_upData_emp.json()))
        # 断言结果：响应状态码，success，code，message
        assert_emp(self, response_upData_emp, 200, True, 10000, "操作成功！")
